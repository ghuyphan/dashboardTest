...

  {
    ...
    children: [
      ...
      },
      {
        ...
        loadComponent: () =>
          import('./features/equipment/device-detail/device-detail.component').then(
      ...
      },
      {
        ...
        loadComponent: () =>
          import('./features/equipment/device-dashboard/device-dashboard.component').then(
            m => m.DeviceDashboardComponent
          ),
        canActivate: [permissionGuard],
        data: {
...

      {
        ...
        loadComponent: () =>
          import('./features/examination-overview/examination-overview.component').then(
            m => m.ExaminationOverviewComponent
          ),
        canActivate: [permissionGuard],
        data: {
...

      {
        ...
        loadComponent: () =>
          import('./features/reports/medical-records-status/medical-records-status.component').then(
            m => m.MedicalRecordsStatusComponent
          ),
        canActivate: [permissionGuard],
        data: {
      ...
      },
      {
        ...
        loadComponent: () =>
          import('./features/reports/cls-level3-report/cls-level3-report.component').then(
            m => m.ClsLevel3ReportComponent
          ),
        canActivate: [permissionGuard],
        data: {
      ...
      },
      {
        ...
        loadComponent: () =>
          import('./features/reports/cls-level6-report/cls-level6-report.component').then(
            m => m.ClsLevel6ReportComponent
          ),
        canActivate: [permissionGuard],
        data: {
      ...
      },
      {
        ...
        loadComponent: () =>
          import('./features/reports/specialty-cls-report/specialty-cls-report.component').then(
            m => m.SpecialtyClsReportComponent
          ),
        canActivate: [permissionGuard],
        data: {
      ...
      },
      {
        ...
        loadComponent: () =>
          import('./features/reports/emergency-summary/emergency-summary.component').then(
            m => m.EmergencySummaryComponent
          ),
        canActivate: [permissionGuard],
        data: {
      ...
      },
      {
        ...
        loadComponent: () =>
          import('./features/reports/emergency-admission-comparison/emergency-admission-comparison.component').then(
            m => m.EmergencyAdmissionComparisonComponent
          ),
        canActivate: [permissionGuard],
        data: {
      ...
      },
      {
        ...
        loadComponent: () =>
          import('./features/reports/surgery-report/surgery-report.component').then(
            m => m.SurgeryReportComponent
          ),
        canActivate: [permissionGuard],
        data: {
      ...
      },
      {
        ...
        loadComponent: () =>
          import('./features/reports/detailed-examination-report/detailed-examination-report.component').then(
            m => m.DetailedExaminationReportComponent
          ),
        canActivate: [permissionGuard],
        data: {
      ...
      },
      {
        ...
        loadComponent: () =>
          import('./features/reports/icd-report/icd-report.component').then(
            m => m.IcdReportComponent
          ),
        canActivate: [permissionGuard],
        data: {
